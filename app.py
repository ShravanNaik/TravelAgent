...
class TravelPlanningCrew:
    ...
    def create_tasks(self, agents):
        ...
        destination_research_task = Task(
            ...
            expected_output="A detailed travel guide with comprehensive destination insights in Markdown format",
        ...
        flight_booking_task = Task(
            ...
            expected_output="A comprehensive list of best flight options with pricing and details in Markdown table format",
        ...
        hotel_booking_task = Task(
            ...
            expected_output="Top 5 hotel recommendations with detailed descriptions in Markdown format",
...
def main():
    ...
    with st.sidebar:
        ...
        special_requirements = st.text_area("Special Requirements", 
                                         "Child-friendly activities, wheelchair accessibility", 
    ...
    if st.button('✨ Create My Travel Plan', use_container_width=True, key="generate"):
        ...
        with st.spinner('Our AI agents are working on your perfect travel plan...'):
            ...
            try:
                ...
                st.info("An error occurred while agents were working. Here's a sample travel plan:")
                
                # Enhanced fallback to sample data with better styling
                with tab1:  # Destination Guide
                    st.markdown("""
                    <div class="tab-content">
                        <h3 style="color: #6B73FF; border-bottom: 2px solid #dfe6e9; padding-bottom: 10px;">
                        ...
                        <h3 style="color: #6B73FF;">Top Attractions</h3>
                        <ul>
                            <li><strong>Grand Palace & Wat Phra Kaew</strong>: Thailand's most sacred temple complex</li>
                            <li><strong>Wat Arun</strong>: The stunning Temple of Dawn along the Chao Phraya River</li>
                            <li><strong>Chatuchak Weekend Market</strong>: One of the world's largest markets with 15,000 stalls</li>
                        </ul>
                        
                        <h3 style="color: #6B73FF;">Best Areas to Stay</h3>
                        <ul>
                            <li><strong>Sukhumvit</strong>: Modern, upscale area with shopping malls and nightlife</li>
                            <li><strong>Silom</strong>: Business district with vibrant night markets and rooftop bars</li>
                            <li><strong>Riverside</strong>: Luxurious hotels with scenic river views</li>
                        </ul>
                    </div>
                    """, unsafe_allow_html=True)
                ...
                with tab2:  # Flight Options
                    ...
                    st.table(pd.DataFrame([
                        {"Airline": "Thai Airways", "Departure": "HYD 10:15", "Arrival": "BKK 16:30", 
                         "Duration": "6h 15m", "Stops": "0", "Price": "$420", "Baggage": "2 checked"},
                        {"Airline": "Singapore Airlines", "Departure": "HYD 14:20", "Arrival": "BKK 22:45", 
                         "Duration": "8h 25m", "Stops": "1 (SIN)", "Price": "$385", "Baggage": "1 checked"}
                    ]))
                    st.markdown("</div>", unsafe_allow_html=True)
                ...
                with tab3:  # Hotel Recommendations
                    ...
                    <div class="tab-content">
                        ...
                        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                            <h4 style="color: #2d3436; margin-top: 0;">1. Sukhumvit Grand Hotel</h4>
                            <p><span style="color: #FFA726;">★★★★☆</span> (4.7) | <strong>$120/night</strong></p>
                            <p><strong>Location:</strong> Sukhumvit Road, central Bangkok</p>
                            <p><strong>Amenities:</strong> Infinity pool, spa, 3 restaurants, free Wi-Fi, fitness center</p>
                            <p><strong>Family friendly:</strong> Kids' club, family rooms available</p>
                        </div>
                        
                        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                            <h4 style="color: #2d3436; margin-top: 0;">2. Riverside Boutique Resort</h4>
                            <p><span style="color: #FFA726;">★★★★☆</span> (4.5) | <strong>$95/night</strong></p>
                            <p><strong>Location:</strong> Chao Phraya River, scenic views</p>
                            <p><strong>Amenities:</strong> Riverfront pool, Thai restaurant, free boat shuttle</p>
                ...
                with tab4:  # Itinerary
                    ...
                    <div class="tab-content">
                        ...
                        <div style="background-color: #f3e5f5; padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                            <h4 style="color: #8e24aa; margin-top: 0;">Day 1: Arrival & Cultural Immersion</h4>
                            
                            <div style="background-color: white; padding: 10px; border-radius: 8px; margin: 10px 0;">
                                <h5 style="color: #6B73FF; margin: 5px 0;">🌅 Morning</h5>
                                <p><strong>8:00 AM - 9:00 AM:</strong> Breakfast at hotel</p>
                                <p><strong>10:00 AM - 12:30 PM:</strong> Visit Grand Palace & Wat Phra Kaew (Entry: 500฿)</p>
                            </div>
                            
                            <div style="background-color: white; padding: 10px; border-radius: 8px; margin: 10px 0;">
                                <h5 style="color: #FFA726; margin: 5px 0;">🌇 Afternoon</h5>
                                <p><strong>1:00 PM - 2:00 PM:</strong> Lunch at Thip Samai (famous Pad Thai, ~150฿)</p>
                                <p><strong>2:30 PM - 4:30 PM:</strong> Wat Pho (Reclining Buddha, 200฿)</p>
                            </div>
                            
                            <p style="text-align: right;"><strong>Estimated Cost:</strong> $85 per person</p>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
